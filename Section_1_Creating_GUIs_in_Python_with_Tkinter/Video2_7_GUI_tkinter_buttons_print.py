...
def click_event():                                      # call back function
    ...
    another_button = ttk.Button(gui, text="Another", command=click_event)    # add same callback function
    another_button.pack() 
    print(another_button)       # we are creating individual button objects
